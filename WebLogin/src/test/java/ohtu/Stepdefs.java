...
public class Stepdefs {
    ...
    public void invalid_username_and_proper_password_are_given(String username, String password) throws Throwable {
        createUser(username, password, password);
    }
    ...
    public void user_is_not_logged_in_and_length_error_message_is_given(String error) throws Throwable {
